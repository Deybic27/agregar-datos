...
public class MainActivity extends AppCompatActivity {
    ...
    Button btnGuardar;
    Spinner cbxDeptos;
    RadioButton rbCompleto, rbMedioTiempo;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        rbMedioTiempo = findViewById(R.id.rbMedioTiempo);

        btnGuardar.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view){
                if(txtNombre.getText().toString().equals("") || txtEmail.getText().toString().equals("")){
                    Toast.makeText(MainActivity.this, "Debe agregar su nombre y correo electrónico", Toast.LENGTH_LONG).show();
                }else{
